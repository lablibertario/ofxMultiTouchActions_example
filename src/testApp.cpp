...
void testApp::tuioCursorAdded(ofxTuioCursor & tcur){
	...
	mtActionsHub.touchDown(tcur.getX(), tcur.getY(), tcur.getSessionId(), &multiTouchCustomData);
	mtSliderHub.touchDown(tcur.getX(), tcur.getY(), tcur.getSessionId(), &multiTouchCustomData);
	...
	*/
	...
	ofxMultiTouch.touchDown(tcur.getX(), tcur.getY(), tcur.getSessionId());
}
...
void testApp::tuioCursorRemoved(ofxTuioCursor & tcur){
	...
	mtActionsHub.touchUp(tcur.getX(), tcur.getY(), tcur.getSessionId(), NULL);
	mtSliderHub.touchUp(tcur.getX(), tcur.getY(), tcur.getSessionId(), NULL);

	//draggableRotatableScalableItem.touchUp(tcur.getX(), tcur.getY(), tcur.getCursorID(), NULL);

	//forward the touch events to ofxMultiTouch for the InteractiveObjects
	ofxMultiTouch.touchUp(tcur.getX(), tcur.getY(), tcur.getSessionId());
}
...
void testApp::tuioCursorUpdated(ofxTuioCursor & tcur){
	...
	mtActionsHub.touchMoved(tcur.getX(), tcur.getY(), tcur.getSessionId(), &multiTouchCustomData);
	mtSliderHub.touchMoved(tcur.getX(), tcur.getY(), tcur.getSessionId(), &multiTouchCustomData);
	/*
	...
	*/
	//forward the touch events to ofxMultiTouch for the InteractiveObjects
	ofxMultiTouch.touchMoved(tcur.getX(), tcur.getY(), tcur.getSessionId());
}
